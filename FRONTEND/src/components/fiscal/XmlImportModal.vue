    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-check mt-3">
            ...
            <small class="d-block text-muted">
              Itens cujo EAN não estiver cadastrado serão ignorados; você poderá vinculá-los manualmente depois.
            </small>
          </div>
        ...
        <div class="modal-footer">
          ...
          <RouterLink v-if="result" :to="`/fiscal/invoices/${result.invoice_id}`" class="btn btn-info"
                      @click="$emit('close')">
            <i class="fas fa-eye mr-1"></i> Ver NFe
          </RouterLink>
...
const cmigId = ref(props.defaultCmigId)
const file = ref(null)
...
async function submit() {
  ...
  try {
    ...
    error.value = e.response?.data?.detail || 'Erro ao importar XML'
  } finally {
