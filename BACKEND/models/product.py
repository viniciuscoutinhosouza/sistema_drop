...
class CatalogProduct(Base):
    ...
    awaiting_return_quantity = Column(Integer, nullable=False, default=0) # cancelado pós-despacho
    pending_validation_quantity = Column(Integer, nullable=False, default=0)  # devolução aguardando inspeção
    unfit_quantity = Column(Integer, nullable=False, default=0)           # reprovado na inspeção
