...
class StockMovement(Base):
    ...
    movement_type = Column(String(40), nullable=False)  # reserve|unreserve|dispatch|await_return|full_in|full_out|...
    qty = Column(Integer, nullable=False)
    field_affected = Column(String(50), nullable=False)  # reserved_quantity|stock_quantity|full_stock|...
