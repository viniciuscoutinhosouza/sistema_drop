from sqlalchemy import Column, Integer, String, Boolean, Numeric, TIMESTAMP, ForeignKey, Text, text, UniqueConstraint
...
class Invoice(Base):
    ...
    __table_args__ = (
        UniqueConstraint("cmig_id", "model", "serie", "nfe_number", name="uq_inv_serie_number"),
