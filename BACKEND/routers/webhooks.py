...
# NF-e própria (SEFAZ direto) é síncrona e a entrada vem da Distribuição de DFe
# (job sync_dfe) — não há mais webhooks do Focus. Removido na Fase 3 da emissão própria.
